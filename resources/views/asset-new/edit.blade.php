                ...
                <form method="post" action="{{route('new.update',$asset->id)}}" enctype="multipart/form-data">
	                ...
	                {{ method_field('PUT') }}
                	 <div class="row clearfix">
	                    ...
	                    <div class="col-sm-3">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="invoice_date" name="invoice_date" class="form-control datepicker" placeholder="Enter Date Of Invoice" value="{{ $asset->invoice_date }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-6 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="party_name" name="party_name" class="form-control" placeholder="Enter party name" value="{{ $asset->vendor_name }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-6 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="gstin" name="gstin" class="form-control" placeholder="Enter party gstin" value="{{ $asset->vendor_gstin }}" >
		                        </div>
		                    </div>
	                    </div>
	                </div>
	                <div class="row clearfix ">
	                	<div class="col-sm-6 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="amount" name="amount" class="form-control" placeholder="Enter amount no" value="{{ $asset->amount }}" >
		                        </div>
		                    </div>
	                    </div>
	                	<div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
			                    <div class="form-line">
			                        <select class="form-control show-tick" id="location" name="location">
			                            ...
			                            <option value="{{$list->name}}" @if($list->name == $asset->location) selected="selected" @endif > {{$list->name}}</option>
			                            @endforeach
			                        </select>
		                    	</div>
	                    	</div>
	                ...
	                <div class="row clearfix ">
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="model" name="model" class="form-control" placeholder="Enter model or asset name" value="{{ $asset->model }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="code" name="code" class="form-control" placeholder="Enter HSN code" value="{{ $asset->code }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="make" name="make" class="form-control datepicker" placeholder="Enter make asset name" value="{{ date_format(date_create($asset->make), 'd F Y') }}" >
		                        </div>
		                    </div>
	                    </div>
	                	<div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="expiry" name="expiry" class="form-control datepicker" placeholder="Enter expiry/warranty/validity date" value="{{ date_format(date_create($asset->expiry), 'd F Y') }}" required>
		                        </div>
		                    </div>
	                    </div>
	                    <!-- <div class="col-sm-6 ">
	                ...
	                <div class="row clearfix vehicle">
	                	<div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="base_amount" name="base_amount" class="form-control" placeholder="Enter base amount no" value="{{ $asset->base_amount }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="tax" name="tax" class="form-control" placeholder="Enter tax no" value="{{ $asset->tax }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="total_tax" name="total_tax" class="form-control" placeholder="Enter total_tax no" value="{{ $asset->total_tax }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="total_amount" name="total_amount" class="form-control" placeholder="Enter total_amount no" value="{{ $asset->total_amount }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
	                    ...
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="insurance" name="insurance" class="form-control datepicker" placeholder="Enter insurance validity" @if(!empty($vehicle)) value="{{ $vehicle->insurance }}" @endif >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="puc" name="puc" class="form-control datepicker" placeholder="Enter puc validity" @if(!empty($vehicle)) value="{{ $vehicle->puc }}" @endif >
		                        </div>
		                    </div>
	                    </div>
	                </div>
