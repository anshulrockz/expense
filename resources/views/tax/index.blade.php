    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a class="btn btn-primary waves-effect header-dropdown m-r--5" href="{{ url('/taxes/create')}}">Create New</a>
            </div>
            <div class="body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form style="display: inline;" method="post" action="{{route('taxes.destroy',$list->id)}}" >
				                        {{ csrf_field() }}
				                        {{ method_field('DELETE') }}
